      ...
      child: Column(
        ...
        ListTile(
          ...
          subtitle: Padding(
            ...
            child: Text('build your career with me', style: TextStyle(color: Colors.black.withOpacity(.4), fontSize: 18)),
          ),
          trailing:  IconButton(onPressed: (){}, icon: Icon(Icons.delete, color: Colors.black, size: 30,)),
        ),
        Padding(
          padding: const EdgeInsets.only(top: 40,right: 20),
          child: Text('21 May 2023', style: TextStyle(color: Colors.black.withOpacity(.4), fontSize: 12),),
        )
      ]),
    );
  }
